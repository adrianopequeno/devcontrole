...
const schema = z.object({
  ...
  description: z.string().min(1, "Descreva sobre o problema..."),
});
...
export const FormTicket = ({ customer }: FormTicketProps) => {
  const {
    register,
    handleSubmit,
    setValue,
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="bg-blue-500 text-white font-bold rounded-md h-11 px-2 py-2 w-full"
      >
        Cadastrar
      </button>
    </form>
